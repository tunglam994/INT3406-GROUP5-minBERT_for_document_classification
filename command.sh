...
#use cpu
python classifier.py --train data/book_summaries_train.csv --dev data/book_summaries_valid.csv --test data/book_summaries_test.csv --dev_out book_summaries_valid_output.txt --test_out book_summaries_test_output.txt --epochs 5 --batch_size 32 --lr 0.0001 --option finetune
